...
export default async function Home() {
  ...
  return (
    <main className="flex min-h-screen flex-col bg-white">
      ...
      {/* Quick Category Grid */}
      <section className="bg-white px-4 py-8 sm:px-6 lg:flex lg:min-h-[85vh] lg:flex-col lg:justify-center">
        <FadeInSection>
      ...
      <section className="px-4 py-8 sm:px-6 bg-[var(--color-background)] lg:flex lg:min-h-[85vh] lg:flex-col lg:justify-center">
        <FadeInSection>
          <div className="max-w-4xl mx-auto">
      ...
      <section className="bg-[var(--color-background)] px-4 py-8 sm:px-6 pb-16 lg:flex lg:min-h-[85vh] lg:flex-col lg:justify-center">
        <FadeInSection>
