-- Rollback backup: public_expert_detail contact-info fields (2026-07-28)
-- Captures the pre-change view definition via pg_get_viewdef against
-- production project oqrxdvwlsbwkhihsvqvt immediately before the fix migration.
-- Restore: run this CREATE OR REPLACE VIEW to revert to the pre-change definition.
