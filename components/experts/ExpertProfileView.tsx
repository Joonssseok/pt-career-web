        ...
        <div className="mt-4 space-y-3">
          ...
          {expert.experiences.length > 0 && (
            <SectionCard icon="💼" title="경력">
              <ul className="relative pl-4 before:content-[''] before:absolute before:left-[3px] before:top-1 before:bottom-1 before:w-px before:bg-gray-200">
                {expert.experiences.map((e, i) => (
                  <li key={i} className="relative pb-4 last:pb-0">
                    <span
                      className={`absolute -left-4 top-1.5 w-2 h-2 rounded-full ring-4 ${
                        e.is_current
