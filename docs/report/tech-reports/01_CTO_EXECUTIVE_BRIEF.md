...
- AD-05A: 거주지역 입력 단위 (시·도만 vs 시·도·군·구)
- AD-05B: 근무지역 입력 단위
...
G3: AD-04, 05A, 05B CEO 결정
    → Decision Pending

G4: M3-A Implementation Figma 및 Handoff
    → Figma Scope: DEFINED / Implementation: NOT STARTED
...
→ Migration, Remote DB, 코드, RLS, Storage 근거 제출

CTO:
→ 기술 근거 검토 (Evidence Matrix)
→ 기술·보안 위험 판정
→ 변경 필요 시 기술 변경안 작성

CEO:
→ 정책·기술 변경 승인 (AD 결정, G0 승인)
→ Figma 착수 승인 (G4)
→ M3-A 착수 승인 (G6)
→ Production 배포 승인
```
