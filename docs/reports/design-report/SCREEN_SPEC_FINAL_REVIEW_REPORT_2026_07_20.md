...
| 구분 | 개수 | CEO 결정 필요 |
|------|------|-----------|
| CEO 확정 제품·운영 결정 | 12개 | **APPROVED** ✅ |
| 추가 검토 필요 결정 | 5개 (AD-01~05) | **Yes** (CEO 승인 대기) |
| 합계 | **17개** | **7개 APPROVED, 5개 승인 대기** |

**추가 결정 항목** (AD-01~AD-05):
- AD-01: 자격번호 필수 여부 (선택 → 필수 변경)
- AD-02: 증빙파일 지원 형식 (CEO 승인 대기)
- AD-03: 증빙파일 최대 용량 (CEO 승인 대기)
- AD-04: 법률검토 동의 필수 여부 (CEO 승인 대기)
- AD-05: 공개가능한 근무지역 단위 (CEO 승인 대기)
...
| 필드 | 용도 | 상태 | M2.1 연계 |
|------|------|------|----------|
| phone_type | 연락처 유형 (official/personal) | Technical Proposal | TM-04 |
| user_rejection_reason | 사용자 전달 반려 사유 | Technical Proposal | TM-05 |
| internal_admin_notes | 관리자 내부 메모 | Technical Proposal | TM-05 |

**확정된 신규 필드**: 0개  
**최종 판정**: M2.1 검증 결과 기반 CTO·CEO 승인
...
|------|------|
| 의료광고 안내문구 | 🔴 법률 검토 필요 |
| AD-04 (법률검토 동의 필드) | 🔴 필드 필수 여부 확인 필요 |
| 담당 | 미지정 (법률팀 담당 필요) |
| CEO 승인 | ⏳ 대기 중 |

**상태**: 법률팀 담당자 지정 후 진행 필요  
**초안 제시**: ✅ (별첨 파일 참조)
...
M2.1 Technical Mapping:        10개 Pending Mapping ⏳

법률 검토:                     의료광고 + AD-04 법률검토 동의 ⏳
...
### 4단계: 법률 검토 (병렬)
- 의료광고 안내문구 법률팀 검증 (담당 미지정)
- 필드별 개인정보 처리 방침 확인

### 5단계: 최종 승인 검토 (M2·법률 완료 후)
- 기술·법률 검토 결과 통합 검증
- 최종 프로필 정책 확정
...
| 2 | SCREEN_SPEC_CTO_CEO_DECISION_MATRIX_2026_07_20.md | 12개 의사결정안 + 5개 M2 항목 + 법률검토 |
